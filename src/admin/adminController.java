...
public class adminController implements Initializable {
    ...
    @FXML
    private JFXTextField txtFirsName;
    ...
    public adminController(TableView<StudentData> studentTable, TableColumn<StudentData, String> idcolum, TableColumn<StudentData, String> firstnamecolum, TableColumn<StudentData, String> lastnamecolum, TableColumn<StudentData, String> emailcolum, TableColumn<StudentData, String> dobcolum, JFXButton btnLoad, TextField searchTxt, JFXTextField txtID, JFXTextField txtFirsName, JFXTextField txtLastName, JFXTextField txtEmail, JFXDatePicker txtDOB) {
        this.studentTable = studentTable;
        this.idcolum = idcolum;
        this.firstnamecolum = firstnamecolum;
        this.lastnamecolum = lastnamecolum;
        this.emailcolum = emailcolum;
        this.dobcolum = dobcolum;
        this.btnLoad = btnLoad;
        this.searchTxt = searchTxt;
        this.txtID = txtID;
        this.txtFirsName = txtFirsName;
...
//Filter Data in TableView
    ...
    private void addStudent(ActionEvent event){
        ...
        try {
            ...
            pr.setString(2,this.txtFirsName.getText());
    ...
    private void deleteStudent(ActionEvent event){
        ...
        JOptionPane.showConfirmDialog(null,
                "Do you want to delete student name:"+std.getFirstName() + " " + std.getLastName());
        //delete
        if (std !=null){
    ...
    private void editStudent(ActionEvent event){
        ...
        if (std !=null) {
            ...
            txtFirsName.setText(std.getFirstName());
    ...
    private void saveStudent(ActionEvent event){
        ...
        try {
            ...
            pr.setString(1,this.txtFirsName.getText());
